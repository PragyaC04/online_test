...
<div class="container">
    ...
    <form action = "{{ action('QualitativeController@update',$sid,$qid)}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="card">
        <div class="card-header">
            <div class="form-group">
                ...
                <input type="text" name="q_number" class="form-control" placeholder="enter question number" value="{{$qual->qid}}">
            </div>

            <div class="form-group">
                <label>Question Content</label>
                <input type="text" name="q_content" class="form-control" placeholder="enter content of question" value="{{$qual->question}}">
            </div>
