...
<div class="container">
    ...
    <div class="card-footer">
        <button type="button" onclick="window.location='<?php echo e(url ("/question")); ?>'" class="btn btn-primary">Edit</button>
...
<?php /**PATH C:\xampp\htdocs\onlinetest\resources\views/viewqualitative.blade.php ENDPATH**/ ?>